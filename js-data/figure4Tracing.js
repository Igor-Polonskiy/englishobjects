(() => {
    ...
    let task = document.querySelector('.figure4_wrapper')
    ...
    function drawfigure2(size, color) {
        ...
        drawTriangle(50-size, 250+size, 300+size, `rgb(${r}, ${g}, ${b+1})`)
        drawTriangle(75-size, 210+size, 250+size, color )
        drawTriangle(110-size, 160+size, 190+size, `rgb(${r}, ${g}, ${b+1})` )
        drawTriangle(140-size, 115+size, 135+size, 'white' )
    };

    function drawTriangle(top_padding, height, width,color) {
