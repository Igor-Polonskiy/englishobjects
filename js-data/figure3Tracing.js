(() => {
    ...
    let task = document.querySelector('.figure3_wrapper')
    ...
    function setupCanvas() {
        ...
        drawfigure2(150, 'rgb(230,230,230)');
    ...
    function drawfigure2(size, color) {
        ...
        cx.fillRect(centerX - size,centerY-size,2*size,2*size);
        cx.fillStyle =color
        cx.fillRect(centerX - size+10,centerY-size+10,2*size-20,2*size-20);
        cx.fillStyle =`rgb(${r}, ${g}, ${b+1})`
        cx.fillRect(centerX - size+30,centerY-size+30,2*size-60,2*size-60);
        cx.fillStyle =`rgb(255, 255, 255)`
        cx.fillRect(centerX - size+40,centerY-size+40,2*size-80,2*size-80);
    };
    ...
    function pixelthreshold() {
        ...
        if (getpixelamount(r, g, b) / figure2pixels > 1.2) {
